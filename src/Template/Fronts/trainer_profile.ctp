                ...
                <div class="row">
                    ...
                    if(!empty($rate_plans)) { ?>
                        <ul class="session_list">
                            <li><h3>1 Session</h3><h2>$<?php echo $rate_plans[0]['rate_hour'] - $rate_plans[0]['adgust1']; ?><span></span></h2><a href="<?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/bookingSession?session=1&rid=".base64_encode($rate_plans[0]['rate_id'])."&tid=".base64_encode($profile_details[0]['user_id']); ?>">Order Now</a></li>
                            <li><h3>3 Session</h3><h2>$<?php echo ( 3 * $rate_plans[0]['rate_hour'] ) - $rate_plans[0]['adgust2']; ?><span></span></h2><a href="<?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/bookingSession?session=3&rid=".base64_encode($rate_plans[0]['rate_id'])."&tid=".base64_encode($profile_details[0]['user_id']); ?>">Order Now</a></li>
                            <li><h3>10 Session</h3><h2>$<?php echo ( 10 * $rate_plans[0]['rate_hour'] ) - $rate_plans[0]['adgust3']; ?><span></span></h2><a href="<?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/bookingSession?session=10&rid=".base64_encode($rate_plans[0]['rate_id'])."&tid=".base64_encode($profile_details[0]['user_id']); ?>">Order Now</a></li>
                            <li><h3>20 Session</h3><h2>$<?php echo ( 20 * $rate_plans[0]['rate_hour'] ) - $rate_plans[0]['adgust4']; ?><span></span></h2><a href="<?php echo ($user['user_type'] == "trainer" || $user['user_type'] == "") ? "javascript:void(0)" : $this->request->webroot."trainees/bookingSession?session=20&rid=".base64_encode($rate_plans[0]['rate_id'])."&tid=".base64_encode($profile_details[0]['user_id']); ?>">Order Now</a></li>
                        </ul>
                    <?php } ?>
                    <div class="clearfix"></div>
                    </div>
