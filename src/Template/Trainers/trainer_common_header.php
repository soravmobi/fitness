                        ...
                        <div class="trainee_top_wrap">
                            ...
                            <?php
                                ...
                                { ?>
                                    ...
                                    <img id="profile-img" style="width:200px;height:190px;" src="<?php echo $this->request->webroot; ?>uploads/trainer_profile/<?php echo $profile_details[0]['trainer_image']; ?>" alt="img" class="img-responsive"></a>
                            <?php }
                                else
                                { ?>
                            ...
                            <?php } ?>
                                <a class="upload_profile_img" href="javascript:void(0);"><input name="trainer_profile_img" id="trainer_profile_img" type="file"/><span class="fa fa-camera"></span> <span>Upload Photo</span></a>
                            </form>
                            </div>
